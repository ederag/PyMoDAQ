...
the up-to-date GitHub repo: https://github.com/PyMoDAQ
using git command line or GitHub Desktop (the latter is recommended for newcomers, just make sure to uncheck "Copy the ... branch only").
Then create a dedicated branch name from the change you want to work on (using git).
